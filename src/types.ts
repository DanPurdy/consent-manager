import {
  CloseBehavior,
  CloseBehaviorFunction,
} from './consent-manager/container';
...
export interface ConsentManagerProps {
  ...
  bannerAcceptButtonContent?: string;
  bannerSettingsButtonContent?: string;
...
export interface PreferenceDialogTranslations {
  acceptAllButtonText: React.ReactNode;
  saveButtonText: React.ReactNode;
  radioAcceptText: React.ReactNode;
  radioDenyText: React.ReactNode;
  columnAllowHeadingText: React.ReactNode;
  columnCategoryHeadingText: React.ReactNode;
  columnToolsHeadingText: React.ReactNode;
  functionalTitleText: React.ReactNode;
  functionalContentText: React.ReactNode;
  marketingTitleText: React.ReactNode;
  marketingContentText: React.ReactNode;
  advertisingTitleText: React.ReactNode;
  advertisingContentText: React.ReactNode;
  essentialTitleText: React.ReactNode;
  essentialContentText: React.ReactNode;
}

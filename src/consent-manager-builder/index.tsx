...
export default class ConsentManagerBuilder extends Component<Props, State> {
  ...
  initialise = async () => {
    const {
      ...
      shouldRequireConsent = ConsentManagerBuilder.defaultProps
    ...
    if (mapCustomPreferences) {
      ...
      const hasInitialPreferenceToTrue = Object.values(
        initialPreferences || {},
      ).some(Boolean);
      const emptyCustomPreferecences = Object.values(
        customPreferences || {},
  ...
  handleSaveConsent = (
    ...
    this.setState(prevState => {
      ...
      console.log('havePreferencesChanged', prevState.havePreferencesChanged);
